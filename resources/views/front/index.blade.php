                    ...
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-sm-10 col-lg-8">
                                <h5 class="text-white text-uppercase mb-3 animated slideInDown">{{ $carousal->subtitle }}
                                </h5>
                                ...
                                <a href="{{ route('camp.index') }}"
                                    class="btn btn-light text-primary py-md-3 px-md-5 animated slideInRight">Join Now</a>
                            </div>
                        </div>
                    </div>
                </div>
